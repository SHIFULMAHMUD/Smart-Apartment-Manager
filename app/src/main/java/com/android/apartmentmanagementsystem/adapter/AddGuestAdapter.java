...
public class AddGuestAdapter extends RecyclerView.Adapter<AddGuestAdapter.MyViewHolder> {

    private List<Guest> guests;
    Context context;

    public AddGuestAdapter(Context context, List<Guest> guests) {
        this.context = context;
        this.guests = guests;
    }

    @Override
    public AddGuestAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.guest_history_item, parent, false);
        return new AddGuestAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AddGuestAdapter.MyViewHolder holder, int position) {
