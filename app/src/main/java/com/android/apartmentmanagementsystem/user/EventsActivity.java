...
import com.android.apartmentmanagementsystem.adapter.EventAdapter;
...
//Internet connection checker
        ...
        if (!cd.isConnectingToInternet()) {
            ...
            Toasty.error(EventsActivity.this, "No Internet Connection", Toasty.LENGTH_LONG).show();
        }else {
    ...
    public void getProfileData(String date, String event) {
        Call<List<Contacts>> call = apiInterface.getEvent(date,event);
        call.enqueue(new Callback<List<Contacts>>() {
            @Override
            public void onResponse(Call<List<Contacts>> call, Response<List<Contacts>> response) {
                progressBar.setVisibility(View.INVISIBLE);
                contactsList = response.body();
                adapter = new EventAdapter(EventsActivity.this, contactsList);
            ...
            public void onFailure(Call<List<Contacts>> call, Throwable t) {
                progressBar.setVisibility(View.INVISIBLE);
                Toast.makeText(EventsActivity.this, "Error : "+ t.toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
